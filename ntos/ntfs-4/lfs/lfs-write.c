...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsWrite:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Log Handle                -> %08lx\n", LogHandle );
    LfsDebugTrace(  0, Dbg, "NumberOfWriteEntries      -> %08lx\n", NumberOfWriteEntries );
    LfsDebugTrace(  0, Dbg, "WriteEntries              -> %08lx\n", WriteEntries );
    LfsDebugTrace(  0, Dbg, "Record Type               -> %08lx\n", RecordType );
    LfsDebugTrace(  0, Dbg, "Transaction Id            -> %08lx\n", TransactionId );
    LfsDebugTrace(  0, Dbg, "UndoNextLsn (Low)         -> %08lx\n", UndoNextLsn.LowPart );
    LfsDebugTrace(  0, Dbg, "UndoNextLsn (High)        -> %08lx\n", UndoNextLsn.HighPart );
    LfsDebugTrace(  0, Dbg, "PreviousLsn (Low)         -> %08lx\n", PreviousLsn.LowPart );
    LfsDebugTrace(  0, Dbg, "PreviousLsn (High)        -> %08lx\n", PreviousLsn.HighPart );
    ...
    __try {
        ...
        __try {
            ...
            LfsDebugTrace( -1, Dbg, "LfsWrite:  Exit\n", 0 );
        }
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsForceWrite:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Log Handle                -> %08lx\n", LogHandle );
    LfsDebugTrace(  0, Dbg, "NumberOfWriteEntries      -> %08lx\n", NumberOfWriteEntries );
    LfsDebugTrace(  0, Dbg, "WriteEntries              -> %08lx\n", WriteEntries );
    LfsDebugTrace(  0, Dbg, "Record Type               -> %08lx\n", RecordType );
    ...
    __try {
        ...
        __try {
            ...
            LfsDebugTrace(  0, Dbg, "Lsn (Low)   -> %08lx\n", Lsn->LowPart );
            LfsDebugTrace(  0, Dbg, "Lsn (High)  -> %08lx\n", Lsn->HighPart );
            LfsDebugTrace( -1, Dbg, "LfsForceWrite:  Exit\n", 0 );
        }
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsFlushToLsn:  Entered\n", 0 );
    LfsDebugTrace(  0, Dbg, "Log Handle        -> %08lx\n", LogHandle );
    LfsDebugTrace(  0, Dbg, "Lsn (Low)         -> %08lx\n", Lsn.LowPart );
    LfsDebugTrace(  0, Dbg, "Lsn (High)        -> %08lx\n", Lsn.HighPart );
    ...
    __try {
        ...
        __try {
            ...
            LfsDebugTrace( -1, Dbg, "LfsFlushToLsn:  Exit\n", 0 );
        }
