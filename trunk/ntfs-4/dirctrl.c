...

{
    ...
    IrpSp = IoGetCurrentIrpStackLocation( Irp );
	pMyIrpSp = (PMyIO_STACK_LOCATION)IrpSp;

    DebugTrace( +1, Dbg, ("NtfsQueryDirectory...\n") );
    DebugTrace( 0, Dbg, ("IrpContext = %08lx\n", IrpContext) );
    DebugTrace( 0, Dbg, ("Irp        = %08lx\n", Irp) );
    DebugTrace( 0, Dbg, (" ->Length               = %08lx\n", pMyIrpSp->Parameters.QueryDirectory.Length) );
    DebugTrace( 0, Dbg, (" ->FileName             = %08lx\n", pMyIrpSp->Parameters.QueryDirectory.FileName) );
    DebugTrace( 0, Dbg, (" ->FileInformationClass = %08lx\n", pMyIrpSp->Parameters.QueryDirectory.FileInformationClass) );
    DebugTrace( 0, Dbg, (" ->FileIndex            = %08lx\n", pMyIrpSp->Parameters.QueryDirectory.FileIndex) );
    DebugTrace( 0, Dbg, (" ->SystemBuffer         = %08lx\n", Irp->AssociatedIrp.SystemBuffer) );
    DebugTrace( 0, Dbg, (" ->RestartScan          = %08lx\n", FlagOn(pMyIrpSp->Flags, SL_RESTART_SCAN)) );
    DebugTrace( 0, Dbg, (" ->ReturnSingleEntry    = %08lx\n", FlagOn(pMyIrpSp->Flags, SL_RETURN_SINGLE_ENTRY)) );
    DebugTrace( 0, Dbg, (" ->IndexSpecified       = %08lx\n", FlagOn(pMyIrpSp->Flags, SL_INDEX_SPECIFIED)) );
    ...
    UserBufferLength = pMyIrpSp->Parameters.QueryDirectory.Length;

    FileInformationClass = pMyIrpSp->Parameters.QueryDirectory.FileInformationClass;
    FileIndex = pMyIrpSp->Parameters.QueryDirectory.FileIndex;
    ...
    RestartScan       = BooleanFlagOn(pMyIrpSp->Flags, SL_RESTART_SCAN);
    ReturnSingleEntry = BooleanFlagOn(pMyIrpSp->Flags, SL_RETURN_SINGLE_ENTRY);
    IndexSpecified    = BooleanFlagOn(pMyIrpSp->Flags, SL_INDEX_SPECIFIED);
    ...
    if ((Ccb->QueryBuffer == NULL) ||
        ((pMyIrpSp->Parameters.QueryDirectory.FileName != NULL) && IndexSpecified)) {
        ...
        if (pMyIrpSp->Parameters.QueryDirectory.FileName == NULL) {
        ...
        //
            ...
            UniFileName = (PUNICODE_STRING) pMyIrpSp->Parameters.QueryDirectory.FileName;
            ...
            FileNameLength = (USHORT)pMyIrpSp->Parameters.QueryDirectory.FileName->Length;
...

{
    ...
    DebugTrace( 0, Dbg, ("IrpContext = %08lx\n", IrpContext) );
    DebugTrace( 0, Dbg, ("Irp        = %08lx\n", Irp) );
    DebugTrace( 0, Dbg, (" ->CompletionFilter = %08lx\n", pMyIrpSp->Parameters.NotifyDirectory.CompletionFilter) );
    DebugTrace( 0, Dbg, (" ->WatchTree        = %08lx\n", FlagOn( pMyIrpSp->Flags, SL_WATCH_TREE )) );
    DebugTrace( 0, Dbg, ("Vcb        = %08lx\n", Vcb) );
    DebugTrace( 0, Dbg, ("Ccb        = %08lx\n", Ccb) );
    DebugTrace( 0, Dbg, ("Scb        = %08lx\n", Scb) );
    ...
    CompletionFilter = pMyIrpSp->Parameters.NotifyDirectory.CompletionFilter;
    WatchTree        = BooleanFlagOn( pMyIrpSp->Flags, SL_WATCH_TREE );
