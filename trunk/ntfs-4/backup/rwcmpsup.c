...

{
    ...
    if (Length != 0) {
        ...
        ((ULONG)PsGetCurrentThread()->TopLevelIrp) = FSRTL_FAST_IO_TOP_LEVEL_IRP;
        ...
        (ULONG)(PsGetCurrentThread()->TopLevelIrp) = 0;
...

{
    ...
    } __except( FsRtlIsNtstatusExpected(Status = GetExceptionCode())
