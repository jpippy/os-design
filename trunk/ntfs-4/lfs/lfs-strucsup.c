...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsAllocateLfcb:  Entered\n", 0 );
    ...
    __try {
        ...
        LfsDebugTrace( -1, Dbg, "LfsAllocateLfcb:  Exit -> %08lx\n", Lfcb );
    }
...

{
    ...
    LfsDebugTrace( +1, Dbg, "LfsDeallocateLfcb:  Entered\n", 0 );
    ...
    LfsDebugTrace( -1, Dbg, "LfsDeallocateLfcb:  Exit\n", 0 );
    return;
}
