...

{
    ...
    TimerStatus = InterlockedExchange( (LONG*)(&NtfsData.TimerStatus), TIMER_NOT_SET );
...

{
    ...
    __try {
        ...
        if (StartTimer) {
            ...
            TimerStatus = InterlockedExchange( (LONG*)(&NtfsData.TimerStatus), TIMER_SET );
...

{
	...
	UNREFERENCED_PARAMETER(FileQuotaInfo);
