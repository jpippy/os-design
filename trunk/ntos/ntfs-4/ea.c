...

{
    ...
    __try {
        ...
        UserBufferLength  = pMyIrpSp->Parameters.QueryEa.Length;
        UserEaList        = (PFILE_GET_EA_INFORMATION) pMyIrpSp->Parameters.QueryEa.EaList;
        UserEaListLength  = pMyIrpSp->Parameters.QueryEa.EaListLength;
        UserEaIndex       = pMyIrpSp->Parameters.QueryEa.EaIndex;
...

{
    ...
    __try {
        ...
        UserBufferLength = pMyIrpSp->Parameters.SetEa.Length;
